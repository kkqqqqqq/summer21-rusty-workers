...
pub struct AppState {
    ...
    /// start time.for computing running time
...
impl Scheduler {
    ...
    pub async fn handle_request(
        ...
        println!("handle_request is running");
        ...
        println!("time now is  {:?}",Instant::now());
        println!("app.start_time is = {:?}",app.start_time);
    ...
    async fn lookup_route_background(&self,mut rx: Receiver<((String, String), oneshot::Sender<()>)>,) {
        loop {
    ...
    async fn do_lookup_app_background(&self, id: AppId) {
        ...
        println!("sched.rs:do_lookup_app_background() is running");
        // Double check
